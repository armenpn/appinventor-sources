...
/**
 * The Component to connect to Esquel ESB for Enterprise Services and Data Entities.
 * @author makj@esquel.com (Jeffrey Mak)
 */
@DesignerComponent(version = YaVersion.WEB_COMPONENT_VERSION,
    description = "Non-visible component that provides functions to connect Enterprise Services and Data Entities",
    category = ComponentCategory.DATADOTESQUEL,
    nonVisible = true,
    iconName = "images/request.png")
@SimpleObject
@UsesPermissions(permissionNames = "android.permission.INTERNET")
@UsesLibraries(libraries = "json.jar")


public class RequestReply extends AndroidNonvisibleComponent implements Component {
  /**
  ...
  private static class CapturedProperties {
    ...
    CapturedProperties(RequestReply web) throws MalformedURLException, InvalidRequestHeadersException {
  ...
  private static final String LOG_TAG = "RequestReply";
   ...
   */
  public RequestReply(ComponentContainer container) {
    ...
    AsynchUtil.runAsynchronously(new Runnable() {
      ...
      public void run() {
        try {
          ...
          form.dispatchErrorOccurredEvent(RequestReply.this, "Get",
    ...
    AsynchUtil.runAsynchronously(new Runnable() {
      ...
      public void run() {
        try {
          ...
          form.dispatchErrorOccurredEvent(RequestReply.this, "PostFile",
              e.getErrorMessageNumber());
        } catch (Exception e) {
          form.dispatchErrorOccurredEvent(RequestReply.this, "PostFile",
    ...
    AsynchUtil.runAsynchronously(new Runnable() {
      ...
      public void run() {
        try {
          ...
          form.dispatchErrorOccurredEvent(RequestReply.this, "Delete",
              e.getErrorMessageNumber());
        } catch (Exception e) {
          form.dispatchErrorOccurredEvent(RequestReply.this, "Delete",
    ...
    AsynchUtil.runAsynchronously(new Runnable() {
      ...
      public void run() {
        ...
        try {
          ...
          form.dispatchErrorOccurredEvent(RequestReply.this, functionName,
