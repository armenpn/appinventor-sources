...
abstract public class EsqEntityList extends AndroidNonvisibleComponent implements Component{
  ...
  private static class CapturedProperties {
    ...
    CapturedProperties(EsqEntityList web) throws MalformedURLException, InvalidRequestHeadersException {
      urlString = web.getURL();
  ...
  private static final String LOG_TAG = "EsqEntityList";
   ...
   */
  public EsqEntityList(ComponentContainer container) {
    ...
    AsynchUtil.runAsynchronously(new Runnable() {
      ...
      public void run() {
        try {
          ...
          form.dispatchErrorOccurredEvent(EsqEntityList.this, "Get",
 ...
 public void PostTextWithEncoding(final String text, final String encoding) {
    ...
    AsynchUtil.runAsynchronously(new Runnable() {
      ...
      public void run() {
        try {
          ...
          form.dispatchErrorOccurredEvent(EsqEntityList.this, "PostFile",
              e.getErrorMessageNumber());
        } catch (Exception e) {
          form.dispatchErrorOccurredEvent(EsqEntityList.this, "PostFile",
    ...
    AsynchUtil.runAsynchronously(new Runnable() {
      ...
      public void run() {
        try {
          ...
          form.dispatchErrorOccurredEvent(EsqEntityList.this, "PutFile",
              e.getErrorMessageNumber());
        } catch (Exception e) {
          form.dispatchErrorOccurredEvent(EsqEntityList.this, "PutFile",
              ErrorMessages.ERROR_WEB_UNABLE_TO_POST_OR_PUT_FILE, path, webProps.urlString);
    ...
    AsynchUtil.runAsynchronously(new Runnable() {
      ...
      public void run() {
        try {
          ...
          form.dispatchErrorOccurredEvent(EsqEntityList.this, "Delete",
              e.getErrorMessageNumber());
        } catch (Exception e) {
          form.dispatchErrorOccurredEvent(EsqEntityList.this, "Delete",
    ...
    AsynchUtil.runAsynchronously(new Runnable() {
      ...
      public void run() {
        ...
        try {
          ...
          form.dispatchErrorOccurredEvent(EsqEntityList.this, functionName,
   ...
   *
   */
  public void setJsonText(String jsonInput) {
    this.jsonText = jsonInput;
  }
   ...
   * Sets the xmlText
   */
  public void setXMLText(String xmlInput) {
    this.xmlText = xmlInput;
  }
 ...
 public void GotText(String url, int responseCode, String responseType, String responseContent) {
   ...
   * @param responseContent the response content from the server
   */
  abstract public void GotResult(String url, int responseCode, String responseType, String responseContent);
        ...
        if (saveResponse) {
          ...
          activity.runOnUiThread(new Runnable() {
            ...
            public void run() {
              ...
              GotResult(webProps.urlString, responseCode, responseType, responseContent);
            }
          });
        }
