...
public class TranslationComponentProperty {
  ...
  public static HashMap<String, String> map() {
    ...
    //========Jeffrey Extend =============
    map.put("QueryHost", MESSAGES.QueryHostProperties());
    map.put("WSHost", MESSAGES.WSHostProperties());
    map.put("QueryDate", MESSAGES.QueryDateProperties());
    map.put("HtmlString", MESSAGES.HtmlStringProperties());

    map.put("Deduplication", MESSAGES.DeduplicationProperties());
    map.put("Topic", MESSAGES.TopicProperties());
    map.put("Status", MESSAGES.StatusProperties());
    map.put("StatusPolarity", MESSAGES.StatusPolarityProperties());
    map.put("DataPath", MESSAGES.DataPathProperties());
    //========End Jeffrey Extend ==========
