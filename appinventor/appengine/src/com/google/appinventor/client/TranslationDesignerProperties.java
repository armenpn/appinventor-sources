...
public class TranslationDesignerProperties {
  ...
  public static String getCorrespondingString(String key) {
    ...
    } else if (key.equals("QueryDate")) {
      //This condition is extended by Jeffrey
      value = MESSAGES.QueryDateProperties();
    } else if (key.equals("QueryHost")) {
      //This condition is extended by Jeffrey
      value = MESSAGES.QueryHostProperties();
    } else if (key.equals("WSHost")) {
      //This condition is extended by Jeffrey
      value = MESSAGES.WSHostProperties();
    } else if (key.equals("Deduplication")) {
      //This condition is extended by Jeffrey
      value = MESSAGES.DeduplicationProperties();
    } else if (key.equals("Topic")) {
      //This condition is extended by Jeffrey
      value = MESSAGES.TopicProperties();
    } else if (key.equals("Status")) {
      //This condition is extended by Jeffrey
      value = MESSAGES.StatusProperties();
    } else if (key.equals("StatusPolarity")) {
      //This condition is extended by Jeffrey
      value = MESSAGES.StatusPolarityProperties();
    } else if (key.equals("DataPath")) {
      //This condition is extended by Jeffrey
      value = MESSAGES.DataPathProperties();
    }
    return value;
  }
}
