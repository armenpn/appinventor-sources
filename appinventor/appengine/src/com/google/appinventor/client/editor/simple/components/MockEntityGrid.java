...
/**
 * Mock Entity Grid component. This is a component which take reference with the WebViewer
 * to give additional functionality for Data.Esquel usage
 *
 * @author makj@esquel.com (Jeffrey Mak)
 */
public final class MockEntityGrid extends MockVisibleComponent {

  /**
   * Component type name.
   */
  public static final String TYPE = "EntityGrid";
  ...
  private final Image largeImage = new Image(images.entitygridbig());
   ...
   */
  public MockEntityGrid(SimpleEditor editor) {
    super(editor, TYPE, images.entitygrid());
